...
function run( xp::fig_2_2;
                ...
                seed::Int64 = 1729 )
    result = Dict{String,Dict{String,Array{Float64,2}}}()
    result["Avg. Mean"]         = Dict{String,Array{Float64,2}}()
    result["Optimal Actions"]    = Dict{String,Array{Float64,2}}()
    ...
    for alg ∈ agents
        ...
        for _round = 1:rounds
            ...
            for _n = 1:T
                ...
                r[_n,_round] = reward
                a[_n,_round] = (armToPull==optimal_arm)?1:0
